export default function ModulKelas() {
  return (
    <section id="modul-kelas" className="my-10">
      <h2 className="mb-3 text-[28px] font-semibold text-gray-900">
        Apa yang akan dipelajari?
      </h2>
      <div className="p-2 flex gap-3 max-sm:items-center mb-3 border-2 border-primary rounded-bl-lg rounded-tr-lg w-fit">
