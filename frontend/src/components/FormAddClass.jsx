  ...
  return (
    ...
    <div className=' padding-x '>
      <div className="flex flex-col w-1/2">
        ...
        <input type="text" name="username" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 w-2/6  focus:ring-0 sm:text-sm outline outline-gray-300 rounded-sm sm:leading-6"/>
        <label htmlFor="" className='font-semibold my-5 ' >Nama Pengajar </label>
        <input type="text" name="username" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 w-2/6  focus:ring-0 sm:text-sm outline outline-gray-300 rounded-sm sm:leading-6"/>
        <label htmlFor="" className='font-semibold my-5 ' >Detail Pengajar </label>
        <input type="text" name="username" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 w-2/6  focus:ring-0 sm:text-sm outline outline-gray-300 rounded-sm sm:leading-6"/>
        <label htmlFor="" className='font-semibold my-5 ' >Durasi</label>
        <input type="text" name="username" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 w-2/6  focus:ring-0 sm:text-sm outline outline-gray-300 rounded-sm sm:leading-6"/>
        <label htmlFor="" className='font-semibold my-5 ' >Rating</label>
        <input type="text" name="username" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 w-2/6  focus:ring-0 sm:text-sm outline outline-gray-300 rounded-sm sm:leading-6"/>
